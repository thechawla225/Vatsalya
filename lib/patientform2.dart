...
class PatientForm2 extends StatefulWidget {
  @override
  _PatientForm2State createState() => _PatientForm2State();
}
...
class _PatientForm2State extends State<PatientForm2> {
  ...
  launchWhatsApp(namee,agee,string1,isonlinee) async {
    var text1 = "Hello Doctor Puneet! I would like to request an appointment for $namee ($_currentgender) who is $agee years old, on the $string1 in the time slot $_currenttime ";
    var text2 = "Hello Doctor Puneet! I would like to request an *ONLINE* appointment for $namee ($_currentgender) who is $agee years old, on the $string1 in the time slot $_currenttime ";

    final link1 = WhatsAppUnilink(
      phoneNumber: '+91-98112 77240',
      text: text1,
    );
  ...
  var _times = ["9am - 1pm" , "6pm - 8 pm" , "Sunday: 9am - 1pm" ];
  ...
  _saveFood() {
    ...
    uploadFood2(_currentFood,  _onFoodUploaded);
            ...
            child: Form(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Text("Select Time (Select Sunday time for Sundays)", style: TextStyle(fontSize: 20.0, color: Colors.black),),
                  DropdownButton<String>(
                    isExpanded: true,
